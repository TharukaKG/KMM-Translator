...
import com.tharuka.traslator_kmm.android.core.theme.LightBlue
import com.tharuka.traslator_kmm.voice_to_text.presentation.DisplayState
import com.tharuka.traslator_kmm.voice_to_text.presentation.VoiceToTextEvent
import com.tharuka.traslator_kmm.voice_to_text.presentation.VoiceToTextState

private const val TAG = "VoiceToTextScreen"
            ...
            FloatingActionButton(
                onClick = {
                    if (state.displayState != DisplayState.DISPLAYING_RESULTS) {
                        onEvent(VoiceToTextEvent.ToggleRecord(languageCode))
                    } else {

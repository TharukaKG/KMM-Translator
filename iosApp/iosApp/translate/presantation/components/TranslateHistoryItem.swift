...
//  iosApp
//
//  Created by Tharuka Gamage on 2023-02-16.
        ...
        Button(action: onClick){
            VStack(alignment: .leading){
                HStack{
                    ...
                    Text(item.fromText).foregroundColor(.lightBlue).font(.body)
                }
                ...
                HStack{
                    ...
                    Text(item.toText).foregroundColor(.onSurface).font(.body.weight(.semibold))
                }
                .frame(maxWidth: .infinity, alignment: .leading)
            }
        }
